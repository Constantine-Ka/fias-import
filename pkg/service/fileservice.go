...
func (s FileServices) Unpacking(path string) []string {
	...
	for _, f := range zipFile.File {
		...
		} else if regexp.MustCompile(`AS_ADDR_OBJ_DIVISION_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_ADDR_OBJ_PARAMS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_ADM_HIERARCHY_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_APARTMENTS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_APARTMENTS_PARAMS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_CARPLACES_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_CARPLACES_PARAMS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_CHANGE_HISTORY_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_HOUSES_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_HOUSES_PARAMS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_MUN_HIERARCHY_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_NORMATIVE_DOCS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_REESTR_OBJECTS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_ROOMS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_ROOMS_PARAMS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_STEADS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_STEADS_PARAMS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_ADDHOUSE_TYPES_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_ADDR_OBJ_TYPES_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_APARTMENT_TYPES_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_HOUSE_TYPES_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_NORMATIVE_DOCS_KINDS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_NORMATIVE_DOCS_TYPES_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_OBJECT_LEVELS_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_OPERATION_TYPES_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_PARAM_TYPES_\d{8}`).Match([]byte(f.Name)) {
		...
		} else if regexp.MustCompile(`AS_ROOM_TYPES_\d{8}`).Match([]byte(f.Name)) {
